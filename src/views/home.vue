<template>
  <div class="min-h-screen flex items-center flex-col gap-y-3 p-4 overflow-auto">
    ...
    <div class="grid grid-cols-1 gap-4 w-full sm:px-12 mt-4 flex-1">
      <!-- User Input Section -->
      <UserInputCard :is-active="step === 1" @generate="handleUserInputGenerate" @next-tab="handleNextTab" />

      <!-- Information Section -->
      <InformationCard :is-active="step === 2" @generate="handleInformationGenerate" :data="informationData"
