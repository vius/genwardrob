    ...
    >
      ...
      >
        ...
        <div class="flex flex-col items-center justify-center">
          <p
            class="relative z-20 font-sans text-base font-bold text-neutral-700 dark:text-neutral-300 mb-3"
          >
            Upload Image
          </p>

          <div class="relative mx-auto mt-10 w-full max-w-xl space-y-4 flex justify-center">
            <Motion
            ...
            <template v-if="!files.length">
              <Motion
                ...
                "
              >
                <ArrowUp class="text-neutral-600 dark:text-neutral-400" :size="32" />
              </Motion>
